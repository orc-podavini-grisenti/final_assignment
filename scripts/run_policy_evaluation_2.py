...
MODEL_EVALUATED = "training/experiments/run_20260105_151445/policy_model.pth"
PATH_OUTPUT = "training/experiments/run_20260105_151445/evaluation"
POLICY_COMPARISON_FILE ="training/experiments/policy_comparison.csv"
...
def run_benchmark(num_episodes=50, fixed_radius=None):
    ...
    for i in range(num_episodes):
        ...
        res = run_simulation(env, path, controller, render=False, max_steps=2000)
